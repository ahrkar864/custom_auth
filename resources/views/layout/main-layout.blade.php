    ...
    <body>
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            ...
            <nav class="my-2 my-md-0 mr-md-3 top-nav">
                ...
                <a href="{{ route('getlogin') }}" class="p-2 text-dark {{(request()->route()->getName()=='getlogin')?'active':''}}">Login</a>
                <a href="{{ route('dashboard') }}" class="p-2 text-dark {{(request()->route()->getName()=='dashboard')?'active':''}}">Profile</a>
        ...
        <footer class="container-fluid" style="height: 100px; background: black;">
        </footer>
